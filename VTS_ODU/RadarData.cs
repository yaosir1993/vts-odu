                ...
                if(datas == null)
                {
                    for (int i = 0; i < 9; i++)
                    {
                        ...
                        switch (i)
                        {
                            ...
                            case 7: radarData.PointCount = Convert.ToInt32(builder.ToString()); break;
                            case 8: radarData.LineCount = Convert.ToInt32(builder.ToString()); break;
                        }
                    }
                    datas = new int[radarData.LineCount, radarData.PointCount];
                }
                //最后一个#号不进行处理
                if (ix == len)
                {
